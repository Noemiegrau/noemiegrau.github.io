...
_.variant="Solid"
_.propTypes=Object(t["a"])({},l["a"].propTypes)},"CO+y":function(e,n,r){"use strict"
...
var j=function(e){Object(c["a"])(r,e)
var n=Object(w["a"])(r)
function r(){Object(t["a"])(this,r)
return n.apply(this,arguments)}Object(a["a"])(r,[{key:"render",value:function(){return d.a.createElement(C["a"],Object.assign({},this.props,{name:"IconNo",viewBox:"0 0 1920 1920"}),O)}}])
r.displayName="IconNoSolid"
return r}(s["Component"])
j.glyphName="no"
j.variant="Solid"
j.propTypes=Object(B["a"])({},C["a"].propTypes)
...
var x=function(e){Object(c["a"])(r,e)
var n=Object(w["a"])(r)
function r(){Object(t["a"])(this,r)
return n.apply(this,arguments)}Object(a["a"])(r,[{key:"render",value:function(){return d.a.createElement(C["a"],Object.assign({},this.props,{name:"IconInfoBorderless",viewBox:"0 0 1920 1920"}),G)}}])
r.displayName="IconInfoBorderlessSolid"
return r}(s["Component"])
x.glyphName="info-borderless"
x.variant="Solid"
x.propTypes=Object(B["a"])({},C["a"].propTypes)
var L=r("97gy")
...
var n=Object(w["a"])(r)
function r(){Object(t["a"])(this,r)
return n.apply(this,arguments)}Object(a["a"])(r,[{key:"render",value:function(){return d.a.createElement(C["a"],Object.assign({},this.props,{name:"IconWarningBorderless",viewBox:"0 0 1920 1920"}),S)}}])
r.displayName="IconWarningBorderlessSolid"
return r}(s["Component"])
I.glyphName="warning-borderless"
I.variant="Solid"
I.propTypes=Object(B["a"])({},C["a"].propTypes)
var z=r("XQb/")
var D=r("J2CL")
var q=r("BTe1")
function A(e){var n=e.colors,r=e.borders,t=e.spacing,a=e.typography,o=e.shadows
return{background:n.backgroundLightest,color:n.textDarkest,marginTop:t.small,borderRadius:r.radiusMedium,borderWidth:r.widthMedium,borderStyle:r.style,contentPadding:"".concat(t.small," ").concat(t.medium),contentFontSize:a.fontSizeMedium,contentFontFamily:a.fontFamily,contentFontWeight:a.fontWeightNormal,contentLineHeight:a.lineHeightCondensed,closeButtonMarginTop:t.xSmall,closeButtonMarginRight:t.xxSmall,iconColor:n.textLightest,successBorderColor:n.borderSuccess,successIconBackground:n.backgroundSuccess,infoBorderColor:n.borderInfo,infoIconBackground:n.backgroundInfo,warningBorderColor:n.borderWarning,warningIconBackground:n.backgroundWarning,dangerBorderColor:n.borderDanger,dangerIconBackground:n.backgroundDanger,boxShadow:o.depth2}}A.canvas=function(e){return{color:e["ic-brand-font-color-dark"]}}
var N,E,T,M,U
...
var F=(N=Object(v["a"])("7.0.0",{closeButtonLabel:"renderCloseButtonLabel"}),E=Object(D["j"])(A,W),N(T=E(T=(U=M=function(e){Object(c["a"])(n,e)
function n(e){var r
Object(t["a"])(this,n)
...
r.state={open:true}
return r}Object(a["a"])(n,[{key:"variantUI",value:function(){return{error:{Icon:j,classNames:b()(W.alert,W.error)},info:{Icon:x,classNames:b()(W.alert,W.info)},success:{Icon:L["a"],classNames:b()(W.alert,W.success)},warning:{Icon:I,classNames:b()(W.alert,W.warning)}}[this.props.variant]}},{key:"clearTimeouts",value:function(){this._timeouts.forEach((function(e){return clearTimeout(e)}))
...
return d.a.createElement("div",{className:W.icon},d.a.createElement(n,{className:W.alertIcon}))}},{key:"renderCloseButton",value:function(){var e=this.props.renderCloseButtonLabel&&Object(f["a"])(this.props.renderCloseButtonLabel)||this.props.closeButtonLabel
return e?d.a.createElement("div",{className:W.closeButton,key:"closeButton"},d.a.createElement(k["a"],{onClick:this.close,size:"small",screenReaderLabel:e})):null}},{key:"renderAlert",value:function(){var e=this.variantUI(),n=e.classNames
return d.a.createElement(R["a"],{as:"div",margin:this.props.margin,className:n,onKeyUp:this.handleKeyUp},this.renderIcon(),d.a.createElement("div",{className:W.content},this.props.children),this.renderCloseButton())}},{key:"render",value:function(){if(this.props.screenReaderOnly){this.getLiveRegion()
...
n.displayName="Alert"
return n}(s["Component"]),M.propTypes={children:g.a.node,variant:g.a.oneOf(["info","success","warning","error"]),margin:D["c"].spacing,liveRegion:g.a.func,liveRegionPoliteness:g.a.oneOf(["polite","assertive"]),isLiveRegionAtomic:g.a.bool,screenReaderOnly:g.a.bool,timeout:g.a.number,renderCloseButtonLabel:g.a.oneOfType([g.a.func,g.a.node]),closeButtonLabel:g.a.string,onDismiss:g.a.func,transition:g.a.oneOf(["none","fade"]),open:g.a.bool},M.defaultProps={variant:"info",margin:"x-small 0",timeout:0,transition:"fade",open:true,screenReaderOnly:false,liveRegionPoliteness:"assertive",isLiveRegionAtomic:false,onDismiss:void 0,liveRegion:void 0,renderCloseButtonLabel:void 0,closeButtonLabel:void 0,children:null},U))||T)||T)},ZbPE:function(e,n,r){"use strict"
...
var C=(k=Object(p["j"])(f,w),k(R=(B=y=function(e){Object(i["a"])(r,e)
var n=Object(c["a"])(r)
function r(){Object(a["a"])(this,r)
...
return Object(t["a"])(g["a"],{as:"p",fontStyle:"italic"},void 0,Object(t["a"])(g["a"],{},void 0,n),r?k:null,r?Object(t["a"])(g["a"],{},void 0,r):null)}render(){let e=null
...
//# sourceMappingURL=7-c-086ca38ea9.js.map